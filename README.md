...
or to PROGRAM_PATH/updater.exe -u "http://127.0.0.1:8095/?path=C:\Users\username\Downloads\&regex=.*\.(png|jpg|jpeg)$"  for auto update\
...
go build -o updater.exe main.go
```
